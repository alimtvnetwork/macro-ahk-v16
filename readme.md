...
```powershell
irm https://github.com/alimtvnetwork/macro-ahk-v15/releases/latest/download/install-extension.ps1 | iex
```

**Linux / macOS (Bash):**

```bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v15/releases/latest/download/install-extension.sh | bash
```
